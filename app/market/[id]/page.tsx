            ...
            {listing.contactWhatsapp && (
              ...
              >
                <svg className="w-6 h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <path d="M12 0C5.373 0 0 5.373 0 12c0 2.125.558 4.118 1.535 5.845L.057 23.486a.5.5 0 00.609.61l5.693-1.48A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.9a9.897 9.897 0 01-5.031-1.371l-.361-.214-3.737.972.994-3.641-.235-.374A9.862 9.862 0 012.1 12C2.1 6.525 6.525 2.1 12 2.1S21.9 6.525 21.9 12 17.475 21.9 12 21.9z"/>
                </svg>
                Message on WhatsApp
              </a>
            )}
